        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <!-- Menu Avis & Suggestions -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-warning"
                           href="#"
                           id="navbarDropdownAvis"
                           role="button"
                           data-bs-toggle="dropdown"
                           aria-expanded="false">
                           <i class="fas fa-comments"></i> Avis & Suggestions
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownAvis">
                            <li><a class="dropdown-item" href="donner_avis.php" target="_blank"><i class="fas fa-qrcode"></i> Borne Adhérent (Saisie)</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="avis_admin.php"><i class="fas fa-chart-bar"></i> Lecture Responsable</a></li>
                        </ul>
                    </li>
