...
<head>
    ...
    <title>Oméga Fitness - Gestion Salle de Sport</title>
        ...
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <div class="logo-container">
                    ...
                    <span class="logo-text">OMÉGA <span class="logo-highlight">FITNESS</span></span>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="challenges.php"><i class="fas fa-trophy"></i> Défis</a></li>
                    <li class="nav-item"><a class="nav-link" href="notifications.php"><i class="fas fa-bell"></i> Notifications</a></li>
                    <li class="nav-item"><a class="nav-link" href="rapports.php"><i class="fas fa-file-alt"></i> Rapports</a></li>
                </ul>
            </div>
        </div>
    </nav>
